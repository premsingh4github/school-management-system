...
{{--    </div>--}}
{{--    <strong>Copyright &copy; {{date('Y')}} <a href="#">@if(isset($appSettings['institute_settings']['name'])){{$appSettings['institute_settings']['name']}}@else Omni I.T. World Pvt. Ltd. @endif</a>.</strong> All rights--}}
{{--    reserved.--}}
{{--</footer>--}}